...
%% Dæmi 4 myndband tekur 4-6 min að Keyra kóðan ----------------------------------------------------
clc
T=30;N=1000;M=N;L=5;
...
% disp(p2(1))
figure
loglog(n,skekkja(1,:),'r',LineWidth=1)
txt1="Hallatala = "+ p1(1) ;text(600,2,txt1) 
xlabel("log(n)")
ylabel("log(skekkja)")
title("loglog plot af sekkkju og n")

figure
loglog(n,skekkja(2,:),"b",LineWidth=1)
txt1="Hallatala = "+ p2(1) ;text(600,0.02,txt1) 
xlabel("log(n)")
ylabel("log(skekkja)")
title("loglog plot af sekkkju og n")
